...
<div className=" ml-[1340px] md:ml-[700px] pa:ml-[1300px]">
  ...
  <img src="/dotted.svg" className="mr-1 w-[50px] md:w-[89.71px] md:h-[113.2px] opacity-0 md:opacity-100 mt-20 items-end justify-end   2xl:opacity-100 pa:opacity-0 xl:opacity-100"/>
  </div>
  </div>
  <img src="./homegaming/grayzig.svg" className="rotate-180 w-full -mt-80 mb-80"/>
