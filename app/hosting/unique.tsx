...
const Unique = () => {
  return (
    <div className="w-full  flex flex-col ma:flex-row h-[1170px] pa:h-[1200px] ma:h-[829px] mt-20 ">
  ...
  <img src="/manupperjumping.svg" className="pa:-mt-[230px] ma:-mt-[280px]  pa:ml-52 ma:-ml-20 relative z-20 w-[150px] ma:w-[271.4px]"/>
