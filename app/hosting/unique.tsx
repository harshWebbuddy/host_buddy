...
const Unique = () => {
  return (
    <div className="w-full  flex flex-col ma:flex-row h-[1170px] pa:h-[1200px] ma:h-[829px] mb-36 mt-20 ">
        <img src="/dotted.svg" className="ml-1 w-[50px] ma:w-[89.71px] ma:h-[113.2px] opacity-0 ma:opacity-100 mt-10"/>
        <div className="ma:w-[1230.66px] ma:h-[668.18px] h-[1100px] flex flex-col ma:flex-row mx-auto gap-0 pa:gap-20">
      <div className="w-[400px] mx-auto ma:w-[699px] ma:h-[608px] margin padding ">
      <div className="mx-auto flex flex-col ma:flex-col pa:flex-row pa:gap-[200px] ma:gap-0 justify-between ma:w-[699px] ma:h-[150px] gap-6 pa:-ml-40 ma:ml-0 ">
       ...
       <p className="ma:w-[699px] pa:w-[1000px] pa:text-[15px] ma:h-[72px]">
      ...
      <div className="mt-24 pr-2 ma:p-0 flex flex-col pa:flex-row ma:flex-col  pa:-ml-48 ma:ml-0  ">
    ...
    <div className="w-[270px] ma:w-[509.66px] ma:h-[708px] relative visible margin pa:-mt-10 ma:mt-20 ma:-ml-20 pa:-ml-40"> 
    <img src="/girljumping.png" className="scale-x-[-1] opacity-100 z-10 relative  grayscale ml-10 ma:ml-0 pa:-mt-1 pa:ml-60"/>
    {/* <img src="/manlowerjumping.svg" className="ma:-mt-60 pa:-mt-40 pa:ml-72 ml-0  relative z-20 w-[200px] ma:w-[328.11px]  "/> */}
    <img src="/manlowerjumping.svg" className="ma:-mt-60 ml-24 pa:ml-80 ma:ml-28 relative z-20 w-[200px] ma:w-[328.11px] pa:-mt-40   "/>
  <img src="/manupperjumping.svg" className="pa:-mt-[230px] ma:-mt-[350px]  pa:ml-52 ma:-ml-2 relative z-20 w-[150px] ma:w-[271.4px]"/>
    {/* // Circle image with eraser */}
    <div className="absolute inset-0 z-0 pa:ml-40 ma:ml-0 pa:-mt-12 ma:mt-0" style={{ width: "400px", height: "400px", transform: "translate(10%, 20%)" }}>
