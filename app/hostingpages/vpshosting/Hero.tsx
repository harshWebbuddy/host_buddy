...
const HeroHosting = () => {
  ...
  useEffect(() => {
    let index = 0;
    const text = "Leverage VPS Power for Ultimate Control, Enhanced Security, and Lightning-Fast Speed. Elevate Your Hosting Experience Now!";
    ...
    <section className="h-full min-h-[80vh] overflow-hidden relative bg-black flex items-center justify-center">
      ...
      <div className="max-w-[1250px] mx-auto text-white px-4 pt-40 pb-10 2xl:py-40">
        <div className="h-full flex items-center relative !z-[2] flex-col 2xl:flex-row justify-center gap-20">
          <div className="relative w-full flex flex-col justify-center 2xl:justify-start space-y-5">
            <div className='relative w-full flex flex-col justify-center 2xl:justify-start space-y-0'>
              <h2 className="font-mono-sans text-sm font-light italic leading-relaxed text-center 2xl:text-left">
                <span className="text-orange-500 font-bold animate-slide-from-left">India VPS Hosting</span>
              </h2>
              <h1 className="font-mono-sans font-semibold text-[62px] leading-[84px] text-center 2xl:text-left animate-zoom-out">
                Top VPS Hosting Provider in India
              </h1>
            </div>
            ...
            <div className="flex flex-row justify-center 2xl:justify-start !mt-10">
              <div className="h-[56px] flex item-center justify-center bg-orange-500 rounded-xl py-4 w-auto px-6 gap-x-3 transition-transform duration-300 transform hover:scale-110">
          ...
          <div className={`w-full item-center justify-center ${imageVisible ? 'animate-slide-from-right' : ''}`}>
