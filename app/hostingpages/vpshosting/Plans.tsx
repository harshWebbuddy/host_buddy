...
const Plans = () => {
  ...
  return (
    <div className="flex flex-col max-w-[1300px] mx-auto">
      <div className="flex flex-col bl:flex-row justify-between gap-y-10 gap-x-30 items-center">
      <div className="relative w-full">
        <AnimatedHeading>Revolutionizing VPS</AnimatedHeading>
        <AnimatedHeading>
          <span className="pb-4 border-b-4 border-orange-500">Hosting </span>
        </AnimatedHeading>
      </div>
      <div className="flex flex-wrap bl:flex-nowrap items-center gap-2 sm:gap-5">
        <AnimatedParagraph>
          Step into a new era of{" "}
          <span className="font-bold">VPS hosting</span>, where unparalleled
          performance and robust IT infrastructure redefine standards. Join us
          in unlocking your website and application's full potential.
        </AnimatedParagraph>
      </div>
    </div>
      {/* cards */}
