...
const HostingPage = () => {
  return (
    <div>
      ...
      <div className="bg-black relative w-full h-[1200px] md:h-[757px] md:overflow-hidden  ">
        ...
        <div className="flex flex-col md:flex-row   ">
          <div className="padding mx-auto absolute w-full md:w-[1920px] h-[757px] top-[100px] md:top-[50px] left-[23px] md:-left-[30px] pa:gap-[400px] gap-[400px] md:gap-[400px] inset-0 items-center justify-center text-white  flex flex-col md:flex-row   ">
            <div className="relative md:w-[600px] md:h-[429px] w-full  ">
              ...
              <div className="w-full md:w-[537px] h-[168px]">
                <h2 className="font-mono-sans text-[29px] pa:text-[50px]  font-medium wording text-left text-white md:text-[62px] md:leading-[84px] pa:leading-[54px]">
                  Start Your Online Journey with Us
                </h2>
              </div>
              <div className="w-[365px] md:w-[600px] pa:w-[800px] h-[78px] -mt-16 pa:-mt-8 md:mt-4 ">
    ...
    <img src="/arrow.svg" width="16px" height="20px"/>
            ...
            <div className="w-[350px]  md:w-[526.79px] pa:w-[600px] h-[60px] md:h-[481.8px] item-center justify-center -mt-[300px]  md:mt-0 mr-40 md:mr-0">
              <img
                src="/HostingHero.svg"
