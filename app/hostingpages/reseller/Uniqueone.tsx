        ...
        <div className="cursor-pointer flex w-full group bg-white transition-all duration-300 border-gradient hover:shadow-2xl rounded-xl "> {/* Fixed height for uniformity */}
          <div className="w-full flex flex-row p-10 space-x-auto justify-between items-center featuresvg4">
            <div className="transition-all duration-300 cursor-pointer xl:gap-6 text-[#16191C]">
              <h2 className="text-[24px] 2xl:text-[28px] font-bold opacity-1 mb-2 group-hover:text-orange-500">{plan}</h2>
            ...
            <div className="transition-all duration-300 cursor-pointer flex flex-row text-[#16191C]">
              <h2 className="text-[38px] 2xl:text-[48px] font-bold opacity-1 group-hover:text-orange-500">$29  
                <span className="font-mona-sans text-[#060318]/45 text-[16px] font-normal leading-normal group-hover:text-[#060318]/45">
                  /Month
                </span>
              </h2>
            </div>
