...
const Support = () => {
  ...
  return (
    <div className="w-full    px-3">
      ...
      <div className="flex flex-col bl:flex-row justify-between gap-y-10 gap-x-32 items-center  pb-16">
        <div className="relative w-full">
        <h2 className="font-mona-sans   text-[42px] leading-relaxed w-full text-center bl:text-left  font-semibold">
        Select Your<span className="pb-4 border-b-4 border-orange-500 font-semibold normal-case "> Reseller</span> Hosting Package
