...
const Uniquecpanel = () => {
  return (
    <section className="relative bg-gradient-to-b from-[#FFFFFF]/100 to-[#FF7500]/70">
      <div className="p-4 w-full max-w-[1300px] mx-auto py-12 2xl:py-24">
        <div className="flex flex-col 2xl:flex-row mx-auto items-center ">
          <div className="slide-reveal w-full flex flex-col space-y-10 2xl:space-y-20">
            <div>
            ...
            <div className="w-full flex flex-col xl:flex-row justify-start gap-8 xl:gap-10 2xl:gap-20">
                  ...
                  <div className="space-y-4 flex flex-col justify-between">
                    <div className="flex items-start mt-10 gap-1 min-[400px]:gap-4">
                      ...
                      <div className="space-y-5 -translate-y-4">
                        <h1 className="text-2xl 2xl:text-3xl font-semibold">24/7 & 365 Days Support</h1>
                        <p className="text-xs 2xl:text-xlleading-loose">
