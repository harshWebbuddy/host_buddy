...
const HeroHosting = () => {
  ...
  return (
    <section className="h-full min-h-[80vh] overflow-hidden relative bg-black flex items-center justify-center">
      ...
      <div className="max-w-[1260px] mx-auto text-white px-4 pt-40 pb-10 2xl:py-40">
        <div className="h-full flex items-center relative !z-[2] flex-col 2xl:flex-row justify-center gap-20 ">
          ...
          <h1 className="font-mono-sans font-medium  text-[51px] 2xl:text-[62px] leading-[84px] text-left 2xl:text-left w-full">Secure & Feature</h1>
            </div>
