  ...
  return (
    ...
    <div className="max-w-[1250px] mx-auto text-white px-4 pt-40 pb-10 2xl:py-40">
      ...
      <div className="relative w-full flex flex-col justify-center 2xl:justify-start space-y-5 animate-left-to-right">
          ...
          <h1 className="font-mono-sans font-semibold text-[62px] leading-[84px] text-center 2xl:text-left">Start Your Online 
Journey with Us</h1>
</div>
          <p className="font-mono-sans text-[18px] font-light leading-loose text-center 2xl:text-left text-[#EBEBEB]">
          Explore our affordable shared hosting plans, offering everything you need to create, host, and manage your website. Enjoy optimal speed, security, and<span className="text-orange-500 opacity-100 font-bold mx-2"> 24/7 expert support.</span>
...
<path d="M22 12C19.333 16.667 16 19 12 19C8 19 4.667 16.667 2 12C4.667 7.333 8 5 12 5C16 5 19.333 7.333 22 12" stroke="white" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"/>
          ...
          <p className="flex max-w-fit mx-auto 2xl:mx-0 gap-2 underline  text-[#FFFFFF]">
              <Image src="/tick2.svg" alt="tick" width={11.41} height={8.27} />
              <span className='opacity-80 capitalize text-[14px] leading-[26px] font-light  '> 30 day money back guarantee</span>
            </p>
        </div>
