...
const Plan2 = () => {
  return (
    <div className='bg-[#D9D9D9] shrink-0'>
         <div className="flex flex-col max-w-[1300px] mx-auto pt-20 pb-16       ">
      {/* heading */}
      <div className="flex flex-col bl:flex-row justify-between gap-y-6 gap-x-4 items-center mb-8">
        <div className="relative w-full">
          <h2 className=" text-white font-mona-sans font-semibold text-[42px] leading-relaxed w-full text-center bl:text-left">
  ...
  <label htmlFor="toggle" className="toggle-label">
    <svg className="toggle-svg" width="72" height="34" viewBox="0 0 72 34" fill="#16191C" xmlns="http://www.w3.org/2000/svg">
      ...
      <circle className="toggle-circle" cx="17.5" cy="17" r="10.5" fill="white"/>
          ...
          <div className="px- py-0.5 bg-orange-100 rounded-3xl ">
      ...
      <section className="mt-10">
        <div className="flex flex-col bl:flex-row w-full justify-center gap-8 items-center">
          <div className="mb-5 w-full bg-white bg-opacity-15  hover:bg-[#F9EFE4] p-10 rounded-2xl">
            ...
            <div className="mt-12">
              ...
              <div className="flex flex-col justify-center w-full mt-12">
                ...
                <button className="relative max-w-fit mx-auto !mt-2 flex group items-center justify-center">
                  <div className="flex items-center gap-x-3 text-[#16191C]/60">
                    <p className="text-[16px] font-bold text-red-500  group-hover:text-orange-500 transition-all duration-500">
