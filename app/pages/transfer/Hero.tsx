...
const HeroHosting = () => {
  return (
    ...
    <h4 className="text-orange-500 font-bold italic">Domain Name Search</h4>
        <h2 className="font-semibold 2xl:font-bold text-2xl sm:text-5xl 2xl:text-7xl capitalize !mt-5 text-center">Domain transfers made easy.</h2>
      ...
      <div className='translate-y-0 2xl:flex hidden'>
