        ...
        <div className="flex flex-col 2xl:flex-row items-center p-10 gap-[85px]">
          ...
          <div className="flex flex-col items-center">
            <div className="space-y-1">
              <Image src="/domains.svg" alt="" width={150} height={40} className="-mb-3" />
          ...
          <div className="space-y-2">
              <Image src="/transfer.svg" alt="" width={300} height={400} className="mt-2"/>
          ...
          <div className="w-full max-w-[1350px] mx-auto bg-[#F5F5F5] rounded-3xl ">
        <div className="flex flex-col 2xl:flex-row items-center p-2 gap-[85px]">
    
          <div className="w-full grid grid-cols-5 xl:grid-cols-5 2xl:grid-cols-5 gap-x-0 gap-y-10 items-center justify-center">
       

          <div className="flex flex-col items-center">
            <div className="space-y-1">
              <Image src="/com.svg" alt="" width={80} height={40} className="-mb-3" />
...
<line x1="0.5" y1="0.63501" x2="0.499998" y2="56.635" stroke="#C8C8C8" stroke-dasharray="2 2"/>
          ...
          <div className="flex flex-col items-center">
          <div className="space-y-2">
              <Image src="/review1.svg" alt="" width={600} height={500} className="mt-2"/>
