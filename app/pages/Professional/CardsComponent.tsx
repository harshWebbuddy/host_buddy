...
const CardsComponent = () => {
  return (
    <div className="">
      <div className=" space-y-10  2xl:space-y-40 p-4 max-w-[1350px] mx-auto ">
        <div className="slide-reveal  background-design w-full flex flex-col-reverse xl:flex-row-reverse justify-between gap-x-40 gap-y-10  2xl:gap-y-20  items-center">
        ...
        <div className="w-full flex justify-center">
          ...
          <div className="">
            <h2 className="text-[24px] xl:text-[32px] 2xl:text-[42px] leading-[33px] 2xl:leading-[63px] font-semibold"><span className="text-orange-500">Email:</span>  Good for Business</h2>
          </div>
          <ul className="w-full ">
            <li className="flex gap-4 items-start">
              <p className="capitalize text-[14px] 2xl:text-[16px] leading-loose">
        ...
        <div className="slide-reveal  background-design w-full flex flex-col xl:flex-row justify-between gap-y-10 2xl:gap-y-20 gap-x-60   items-center">
        <div className="w-full 2xl:flex hidden justify-center">
           ...
           <h4 className="text-[24px] xl:text-[32px] 2xl:text-[42px] leading-[33px] 2xl:leading-[63px] font-semibold">
  ...
  <p className="capitalize text-[14px] 2xl:text-[16px] leading-loose">
    Weve updated our Professional Email plans to make it simple, secure, and mobile-friendly. Now you can sync all your accounts across all devices, promote your business every time you send and receive emails, easily manage folders, and more. Plus, it’s cost-effective.    </p>
       ...
       <div className="slide-reveal  background-design w-full flex flex-col-reverse xl:flex-row-reverse justify-between gap-y-20 gap-x-60   items-center">
  ...
  <p className="capitalize text-[14px] 2xl:text-[16px] leading-loose">
    Professional Email works with Outlook, Apple Mail and other top programs to keep all your devices — from your laptop to your smartphone and tablet — up to date and in sync. Your latest emails, contacts, and appointments are at your fingertips, wherever you are.  </p>
       ...
       <div className="slide-reveal  background-design w-full flex flex-col xl:flex-row justify-between gap-y-10 2xl:gap-y-20 gap-x-40   items-center">
       <div className="w-full 2xl:flex hidden  justify-center">
           <div className="relative">
             <Image
