  ...
  return (
    <div className="">
      <div className="  space-y-24 p-4 max-w-[1350px] mx-auto  ">
        ...
        <div className="w-full flex justify-center pt-60 items-center ">
          ...
          <div className="">
            <h2 className="text-[42px] leading-[63px] font-semibold">Google Suite<span className="text-orange-500"> Security Features</span> </h2>
          </div>
          <ul className="w-full space-y-4">
            <li className="flex gap-4 items-start">
              <Image src="/tick1.svg" alt="tick" width={20} height={20} className="mt-3" />
              <p className="capitalize leading-loose pr-10">
            ...
            <li className="flex gap-4 items-start">
              <Image src="/tick1.svg" alt="tick" width={20} height={20} className="mt-3" />
              <p className="capitalize leading-loose pr-16">
