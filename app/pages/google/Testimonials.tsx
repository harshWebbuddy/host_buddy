...
export default function Testimonials() {
  ...
  return (
    <div className="p-4 relative  mx-auto flex flex-col w-full items-center justify-center pt-10 2xl:pt-20 mt-10 2xl:mt-20">
      ...
      <img src="/plenk/fog.svg" className="absolute top-60 rotate-180 select-none" />
