...
const CardsComponent = () => {
  return (
    <div className="space-y-16 2xl:space-y-40 p-4 max-w-[1300px] mx-auto pt-20 2xl:pt-40 pb-20 2xl:pb-32">
      ...
      <div className="slide-reveal w-full flex flex-col xl:flex-row-reverse space-y-10 2xl:space-y-16 items-center">
      ...
      <div className="slide-reveal w-full flex flex-col xl:flex-row-reverse gap-4 2xl:gap-16 items-center">
      <div className="w-full flex justify-center">
          <div className="relative">
