...
const HeroHosting = () => {
  ...
  return (
    <section className="h-full min-h-[80vh] overflow-hidden relative bg-black flex items-center justify-center">
      ...
      <div className="max-w-[1280px] mx-auto text-white px-4 pt-40 pb-10 2xl:py-20">
        <div className="h-full flex items-center relative !z-[2] flex-col 2xl:flex-row justify-center gap-20 ">
          <div className="relative w-full flex flex-col justify-center 2xl:justify-start space-y-5 animate-left-to-right">
            <div className='relative w-full flex flex-col justify-center 2xl:justify-start space-y-0'>
              ...
              <h1 className="font-mono-sans font-semibold text-[56px] leading-[84px] text-center 2xl:text-left ">
...
with Microsoft 365
          ...
          <div className="w-full item-center  flex flex-col justify-center animate-slide-from-rightdirection">
            <Image src="/mic.gif" alt="" width={500} height={500} className="item-center justify-center mx-auto" />
            <img src="/microsoft/plan.svg" className="w-full -translate-y-24 px-40 mx-auto"/>
          </div>
        </div>
      </div>
    </section>
