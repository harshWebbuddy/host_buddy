    ...
    <div className="bg-black w-full py-10 2xl:py-20">
      <div className="  space-y-20 2xl:space-y-40 p-4 max-w-[1350px] mx-auto ">
        ...
        <div className="w-full flex justify-center">
          ...
          <div className="">
            <h2 className="text-[26px] xl:text-[32px] 2xl:text-[42px] leading-[43px] 2xl:leading-[63px] capitalize font-semibold text-white">Your anytime, anywhere office to  <span className="text-orange-500">grow your business</span></h2>
          </div>
