   ...
   <div className=''> 
    ...
    <div className="slide-reveal flex flex-col bl:flex-row justify-between gap-y-6 gap-x-4 items-center mb-8 " >
     <div className="relative w-full pr-64">
        <h2 className="text-black font-mona-sans font-semibold text-[44px]  leading-relaxed w-full text-center bl:text-left">
        Select Your Micros<span className="pb-4 border-b-4 border-orange-500 text-wite text-black">oft 365 Plan {" "}  </span>  {" "}
        </h2>
      </div>
    ...
    <section className="mt-10" ref={ref}>
      ...
      <div className={`slide-item ${animationClass} w-full`}>
          ...
          <div className="pt-10 lex flex-col w-full space-y-2 group">
            <h2 className="font-mona-sans pb-6 font-bold text-2xl bl:text-3xl text-center gap-0  mx-auto text-gray-900 group-hover:text-white"><img src="/microsoft/plan.svg" className="w-full px-12 mx-auto"/></h2>
            <p className="font-mona-sans text-sm font-normal leading-7 text-center  gap-0 opacity-45 group-hover:text-white text-[#16191C]/100 bottom-4 relative"></p>
            <div className="font-bold text-6xl leading-9 text-center font-mono-sans-serif text-orange-500 mb-2">$29</div>
            <p className="font-mona-sans text-base font-normal leading-21 text-center w-50 h-[17px] gap-0 opacity-45 pt-2  group-hover:text-white text-[#16191C]/100">/Month</p>
          </div>
        ...
        <div className={`slide-item ${animationClass} w-full`}>
         ...
         <div className='group-hover:opacity-100 opacity-0 absolute -translate-y-4 translate-x-24 2xl:flex hidden'>
          <div className='bg-orange-500 py-1 rounded-3xl border-white w-36  mx-auto item-center justify-center border-4'>
            <h2 className='text-white items-center justify-center mx-auto text-center text-[16px] font-semibold '>Best Selling</h2>
          </div>
          </div>
          <div className="pt-10 lex flex-col w-full space-y-2 group">
          <h2 className="font-mona-sans pb-6 font-bold text-2xl bl:text-3xl text-center gap-0  mx-auto text-gray-900 group-hover:text-white"><img src="/microsoft/plan.svg" className="w-full px-12 mx-auto"/></h2>
