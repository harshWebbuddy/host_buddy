    ...
    <section className="relative b">
      <div className="p-4 w-full max-w-[1350px] mx-auto ">
        <div className="flex flex-col 2xl:flex-row mx-auto items-center ">
          <div className="slide-reveal w-full flex flex-col space-y-8 2xl:space-y-16">
            <div className="2xl:pr-96">
              <h2 className="text-[27px] xl:text-[37px] 2xl:text-[47px]  capitalize leading-normal  font-semibold text-black w-full 2xl:max-w-full">
              5 steps to consider if you manually 
install your <span className="pb-1 2xl:pb-4 border-b-4 border-orange-500">SSL certificate</span>
              </h2>
            </div>
            <div className="w-full flex flex-col xl:flex-row justify-start gap-20 xl:gap-10 2xl:gap-20">
              ...
              <div className="w-full">
                <div className="flex">
                  <Image draggable={false} src="/line-svg.svg" alt="" width={6} height={404} className="2xl:flex hidden h-[700px] object-cover select-none" />
                  <div className="space-y-4 flex flex-col justify-between">
                    <div className="flex items-start mt-10 gap-1 min-[400px]:gap-4">
                      ...
                      <div className="space-y-0 -translate-y-3.5">
                        ...
                        <h1 className="text-2xl 2xl:text-3xl font-semibold">Request the SSL</h1>
                         <p className="leading-loose text-[14px] 2xl:text-[20px] pt-2 2xl:pt-4">
                    ...
                    <div className="flex items-start mt-10 gap-1 min-[400px]:gap-4">
                      ...
                      <div className="space-y-0 -translate-y-3.5">
                        ...
                        <h1 className="text-2xl 2xl:text-3xl font-semibold">Verify your SSL</h1>
                         <p className="leading-loose text-[14px] 2xl:text-[20px] pt-2 2xl:pt-4">
                    ...
                    <div className="flex items-start mt-10 gap-1 min-[400px]:gap-4">
                      ...
                      <div className="space-y-0 -translate-y-3.5">
                        ...
                        <h1 className="text-2xl 2xl:text-3xl font-semibold">Download your SSL</h1>
                         <p className="leading-loose text-[14px] 2xl:text-[20px] pt-2 2xl:pt-4">
                    ...
                    <div className="flex items-start mt-10 gap-1 min-[400px]:gap-4">
                      ...
                      <div className="space-y-0 -translate-y-3.5">
                        ...
                        <h1 className="text-2xl 2xl:text-3xl font-semibold">Redirect HTTP</h1>
                         <p className="leading-loose text-[14px] 2xl:text-[20px] pt-2 2xl:pt-4">
                    ...
                    <div className="flex items-start mt-10 gap-1 min-[400px]:gap-4">
                      ...
                      <div className="space-y-0 -translate-y-3.5">
                        ...
                        <h1 className="text-2xl 2xl:text-3xl font-semibold">Check Installation</h1>
                        <p className="leading-loose text-[14px] 2xl:text-[20px] pt-2 2xl:pt-4">
              ...
              <Image src="/ssl/unique.svg" alt="" width={600} height={582} className="2xl:flex hidden rounded-3xl object-cover h-[700px]" />
            </div>
          </div>
        </div>
      </div>
