...
export default function Features() {
  ...
  return (
    ...
    <div className=" p-2 2xl:p-0 relative bg-gradient-to-b from-[#FFFFFF]/70 to-[#FF7500]/90 2xl:to-[#FF7500]/70 mx-auto flex flex-col w-full items-center justify-center pt-10 2xl:pt-20 2xl:mt-20 opacity-100">
          ...
          {visibleTestimonials.map(
            (testimonial, index) =>
              index % columns === columnIndex && (
                <div key={index} className="group relative bg-[#FFF3EA] hover:bg-[#FFFFFF] px-8 py-10 rounded-2xl space-y-5 flex flex-col flex-grow min-h-[200px]">
