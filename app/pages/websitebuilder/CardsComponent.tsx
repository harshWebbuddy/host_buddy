    ...
    <div className="">
      <div className="  space-y-24 p-4 max-w-[1350px] mx-auto ">
        <div className=" background-design w-full flex flex-col xl:flex-row-reverse justify-between gap-x-40 gap-y-20  items-center">
          ...
          <div className="">
            <h2 className="text-[42px] leading-[63px] font-semibold">Stunning <span className="text-orange-500">Website Templates</span> to Empower Your Success</h2>
          </div>
...
schemes and fonts.
  ...
  <li className="flex gap-4 items-start">
    <Image src="/tick1.svg" alt="tick" width={20} height={20} className="mt-3" />
    <p className="capitalize leading-loose pr-24">
...
via live chat or email.  </p>
  ...
  <li className="flex gap-4 items-start">
    <Image src="/tick1.svg" alt="tick" width={20} height={20} className="mt-3" />
    <p className="capitalize leading-loose pr-32">
...
smooth communication
  ...
  <li className="flex gap-4 items-start">
    <Image src="/tick1.svg" alt="tick" width={20} height={20} className="mt-3" />
    <p className="capitalize leading-loose pr-20">
