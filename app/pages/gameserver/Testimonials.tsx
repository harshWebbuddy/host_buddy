...
export default function Testimonials() {
  ...
  return (
    ...
    <div className="p-4 relative bg-[#F9EFE4] 2xl:bg-[#FFFFFF] bl:bg-[#F9EFE4] lg:bg-[#F9EFE4] md:bg-[#F9EFE4] sm:bg-[#F9EFE4]  mx-auto flex flex-col  w-full items-center justify-center pt-10 2xl:pt-20">
