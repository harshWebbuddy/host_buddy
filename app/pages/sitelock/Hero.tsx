...
const HeroHosting = () => {
  ...
  return (
    <section className="h-full min-h-[75vh] overflow-hidden relative bg-black flex items-center justify-center">
      ...
      <div className="max-w-[1270px] mx-auto text-white px-4 pt-40 pb-10 2xl:py-32">
          ...
          <div className="relative w-full flex flex-col justify-center 2xl:justify-start space-y-5 animate-left-to-right">
            <div className='relative w-full flex flex-col justify-center 2xl:justify-start space-y-0'>
              <h2 className="font-mono-sans text-sm font-light italic leading-relaxed text-center 2xl:text-left">
                <span className="text-orange-500 font-bold ">Sitelock</span>
              </h2>
...
Protector
            ...
            <p className="font-mono-sans text-[15px]   font-light leading-loose text-center 2xl:text-left text-[#EBEBEB]">
          ...
          <div className="w-full item-center justify-center animate-slide-from-rightdirection">
            <Image src="/sitelock/hero.svg" alt="" width={1000} height={800} className="item-center justify-center mx-auto" />
          </div>
        </div>
      </div>
    </section>
