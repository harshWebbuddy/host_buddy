...
const Plan2 = () => {
  ...
  <label htmlFor="toggle" className="toggle-label">
    ...
    {/* cards */}
    <section className="2xl:mt-10 p-4">
    <div className="flex flex-col bl:flex-row w-full justify-center gap-8 items-center" >
      ...
      <div className="slide-reveal mb-5 w-full transition-all gap-10 sm:gap-16 md:gap-20 lg:gap-32 xl:gap-48 2xl:gap-96 bg-[#F9EFE4] hover:bg-[#16191C] p-5 sm:p-10 flex flex-col 2xl:flex-row rounded-2xl group">
  <div className="space-y-10 sm:space-y-20 md:space-y-30 lg:space-y-40 px-5 sm:px-10 md:px-15 lg:px-20">
    <div className="flex flex-col w-full space-y-2 group">
      <h2 className="font-mona-sans font-bold text-xl sm:text-2xl md:text-3xl text-center text-gray-900 group-hover:text-white">DS4</h2>
      <p className="font-mona-sans text-sm font-normal leading-7 text-center opacity-45 group-hover:text-white text-[#16191C]">From</p>
      <div className="font-bold text-4xl sm:text-5xl md:text-6xl leading-9 text-center text-orange-500 mb-2">$29</div>
      <p className="font-mona-sans text-base font-normal leading-21 text-center opacity-45 group-hover:text-white text-[#16191C]">/Month</p>
    </div>

    <div className='featuresvg3 2xl:flex hidden'>
  ...
  <div className="w-full space-y-5 sm:space-y-10">
    <div className="flex flex-col justify-center w-full group">
      <h3 className="text-lg sm:text-xl font-bold mb-3 sm:mb-7 text-left text-black group-hover:text-white">Major Features</h3>
      <div className="flex flex-col gap-2 sm:gap-5">
        <div className="flex w-full justify-between">
          <p className="text-black text-center text-sm sm:text-lg group-hover:text-white">RAM:</p>
          <p className="text-black text-center text-sm sm:text-lg font-bold group-hover:text-white">8GB</p>
        </div>
        <div className="flex w-full justify-between">
          <p className="text-black text-center text-sm sm:text-lg group-hover:text-white">Processor</p>
          <p className="text-black text-center text-sm sm:text-lg font-bold group-hover:text-white">1 Core</p>
        </div>
        <div className="flex w-full justify-between">
          <p className="text-black text-center text-sm sm:text-lg group-hover:text-white">Storage</p>
          <p className="text-black text-center text-sm sm:text-lg font-bold group-hover:text-white">25GB</p>
        </div>
        <div className="flex w-full justify-between">
          <p className="text-black text-center text-sm sm:text-lg group-hover:text-white">Bandwidth</p>
          <p className="text-black text-center text-sm sm:text-lg font-bold group-hover:text-white">1TB</p>
        </div>
      </div>
      <div className="relative max-w-fit mx-auto py-3 sm:py-6 flex group items-center justify-center">
        <div className="flex items-center gap-x-1 sm:gap-x-3">
          <p className="text-[12px] sm:text-[16px] font-bold text-[#16191C]/60 group-hover:text-orange-500 transition-all duration-500">
            See All Features in Details
          </p>
          <IoIosArrowForward className="text-[#16191C]/60 group-hover:text-orange-500 group-hover:translate-x-1 transition-all duration-300" />
        </div>
        <div className="bg-orange-500 h-[2px] absolute bottom-1 sm:bottom-5 left-0 w-0 group-hover:w-full transition-all duration-500" />
      </div>
    </div>

    <a href="/footer/configurator">
      <div className="group w-full h-[40px] sm:h-[52px] text-white text-base sm:text-xl rounded-xl bg-[#F9EFE4] group-hover:bg-[#FF7500] ring-1 ring-[black] group-hover:ring-[#16191C] transition-all duration-300 hover:shadow-2xl ring-inset hover:ring-0 font-bold flex items-center justify-center">
        <h4 className="font-monasans font-bold leading-[19.2px] text-black group-hover:text-white">Configure</h4>
        <span className="ml-4 sm:ml-8 -mt-0.5 featuresvg3">
