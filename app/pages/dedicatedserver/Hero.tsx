  ...
  return (
    <section className=''>
      <section className="min-h-[20vh] overflow-hidden relative bg-black flex items-center justify-center">
        ...
        <div className="max-w-[1280px] mx-auto text-white px-4 pt-40 pb-10 2xl:py-32">
          <div className="h-full flex items-center relative !z-[2] flex-col 2xl:flex-row justify-center gap-20 ">
            <div className="relative w-full flex flex-col justify-center 2xl:justify-start space-y-5 animate-left-to-right">
              <div className='relative w-full flex flex-col justify-center 2xl:justify-start space-y-0'>
                ...
                <h1 className="font-mono-sans font-semibold text-[50px] leading-[84px] text-center 2xl:text-left ">
                Powerful Dedicated
                </h1>
                <h1 className="font-mono-sans font-semibold text-[50px] leading-[84px] text-center 2xl:text-left ">
