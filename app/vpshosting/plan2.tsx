...
const Plan2 = () => {
  return (
    <div className='w-full 2xl:h-[1100px] bl:h-[1200px] xl:h-[1100px] lg:h-[1800px] sm:h-[2000px] bg-[#D9D9D9]'>
      <div className='pt-20 plan mx-auto'>
    ...
    <div className='plan2 mx-auto'>
        ...
        <div className='group'>
          <div className='plan2box  bg-[#16191C] group-hover:bg-[#F9EFE4]'>
    <div className='.plan2boxinner mt-8'>
        <div className='plan2boxinner1 mx-auto'>
          <div className=''>  <div>
                <h2 className='ignite font-mono-sans mx-auto  text-white group-hover:text-black'>Ignite</h2>
            </div>
            <div>
    <h2 className='from font-mono-sans mx-auto  text-white group-hover:text-black '>From</h2>
            </div>
            </div>
            <div className=''>  <div>
            ...
            <div>
    <h2 className='from font-mono-sans mx-auto  text-white group-hover:text-black'>/Month</h2>
            </div>
            </div>
        </div>
        ...
        <div className='plan2boxinner22'>
         <div className='.planbutton border-2 border-white group-hover:bg-[#FF7500]	 rounded-xl p-3 items-center justify-center flex flex-row'>
            <h2 className='text-[16px] font-bold leading-[19.2px]  text-white '>Choose Plan </h2>
             <svg className='item-center justify-center ml-4' width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M5.13672 0.947266L5.69531 0.388672C5.94922 0.160156
     ...
     5.56836 11.7383 5.94922 11.5098 6.17773L6.55859 11.1289C6.33008
      ...
      6.76172 0.3125 6.50781 0.3125 6.15234V5.33984C0.3125 5.00977 0.566406 4.73047 0.921875 4.73047H8.20898L5.13672 1.83594C4.9082 1.58203 4.88281 1.20117 5.13672 0.947266Z" fill="#FFFFFF"/>
    </svg>
    
    </div>
    <div className='features'>
    <div className='text-[16px] font-bold font-mono-sans leading-[24px]  text-white group-hover:text-black'><h2>Major Features</h2></div>
    <div className='flex flex-col gap-[10px] '>
      <div className='subfeatures group'>
        <h2 className='font-normal text-white group-hover:text-black'>RAM</h2>
    <h2 className='font-semibold  text-white group-hover:text-black'>1GB</h2>
    </div>
     <div className='subfeatures group'>
        <h2 className='font-normal  text-white group-hover:text-black'>Processor</h2>
    <h2 className='font-semibold  text-white group-hover:text-black'>1 Core</h2>
    </div>
     <div className='subfeatures group'>
        <h2 className='font-normal  text-white group-hover:text-black'>Storage</h2>
    <h2 className='font-semibold  text-white group-hover:text-black'>25GB</h2>
    </div>
     <div className='subfeatures group'>
        <h2 className='font-normal  text-white group-hover:text-black'>Bandwidth</h2>
    <h2 className='font-semibold  text-white group-hover:text-black'>1TB</h2>
    </div>
    </div>
    
    </div>
    </div>
    <div className='flex flex-row items-center justify-center featuresvg1 '>
      <h2 className='text-[16px] font-semibold leading-[24px]  text-white group-hover:text-[#FF7500] opacity-45 group-hover:opacity-100 '>See All Features in Details </h2>
    ...
    <path d="M1.51562 13L7.51562 7L1.51562 1" stroke="#FFFFFF" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
        ...
        <div className='group '>
          <div className='plan2box special   bg-[#16191C] group-hover:bg-[#F9EFE4]'>
    <div className='.plan2boxinner mt-8'>
        <div className='plan2boxinner1 mx-auto'>
          <div className=''>  <div>
          <h2 className='ignite font-mono-sans mx-auto  text-white group-hover:text-black'>ELITE</h2>
            </div>
            <div>
            <h2 className='from font-mono-sans mx-auto  text-white group-hover:text-black '>From</h2>
            </div>
    ...
    <h2 className='from font-mono-sans mx-auto  text-white group-hover:text-black'>/Month</h2>
        ...
        <div className='.planbutton border-2 border-white group-hover:bg-[#FF7500]	 rounded-xl p-3 items-center justify-center flex flex-row'>
        <h2 className='text-[16px] font-bold leading-[19.2px]  text-white '>Choose Plan </h2>
             <svg className='item-center justify-center ml-4 svghover	' width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M5.13672 0.947266L5.69531 0.388672C5.94922 0.160156
     6.33008 0.160156 6.55859 0.388672L11.5098 5.31445C11.7383 
     5.56836 11.7383 5.94922 11.5098 6.17773L6.55859 11.1289C6.33008
      11.3574 5.94922 11.3574 5.69531 11.1289L5.13672 10.5703C4.9082 
    ...
    <div className='.plan2boxinner mt-8'>
        <div className='plan2boxinner1 mx-auto'>
          <div className=''>  <div>
                <h2 className='ignite font-mono-sans mx-auto  text-white group-hover:text-black'>STELLER</h2>
            </div>
            <div>
    <h2 className='from font-mono-sans mx-auto  text-white group-hover:text-black '>From</h2>
            </div>
    ...
    <h2 className='from font-mono-sans mx-auto  text-white group-hover:text-black'>/Month</h2>
        ...
        <div className='plan2boxinner22'>
        <div className='.planbutton border-2 border-white group-hover:bg-[#FF7500]	 rounded-xl p-3 items-center justify-center flex flex-row'>
            <h2 className='text-[16px] font-bold leading-[19.2px]  text-white group-hover:text-black '>Choose Plan </h2>
            <svg className='item-center justify-center ml-4 svghover	' width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M5.13672 0.947266L5.69531 0.388672C5.94922 0.160156
     6.33008 0.160156 6.55859 0.388672L11.5098 5.31445C11.7383 
     5.56836 11.7383 5.94922 11.5098 6.17773L6.55859 11.1289C6.33008
    ...
    <img src="/vpshosting/background.svg" className='relative left-20'/>
        </div>
        </div>
  )
}
