...
<div className="mx-auto static 2xl:absolute w-full 2xl:w-[1220.25px] h-full   mp:p-4   2xl:h-[757px] 2xl:mt-10 2xl:gap-20 2xl:p-0 pa:-mt-[350px] mp:gap-10 mp:-mt-10 sm:p-2 sm:-mt-24 sm:gap-10 pa:gap-14 md:-mt-80 md:gap-40  sd:h-[600px] sd:p-20  sd:flex-row sd:-mt-[720px] inset-0 items-center  text-white  flex flex-col 2xl:flex-row justify-between    ">
      <div className="relative md:w-[600px] md:h-[429px] w-full flex flex-col pa:mb-20 ">
        ...
        <div className="w-full md:w-[600px] h-[78px] mt-28 md:mt-0 mb-10 sm:mt-24 mp:mt-0 sm:mb-20 mp:mb-20 2xl:mb-10 pa:mb-10">
        <p className="font-mono-sans text-[18px] font-light leading-[26px] text-left">
          <span className="opacity-90">By trusting us with your business and projects needs, we promise a</span>
        ...
        <div className="flex flex-row w-[350px] ">
          <div className="mp:w-[140px] 2xl:w-[184.95px] h-[52px] bg-orange-500 text-white  rounded-xl">
              <div className="w-[184.95px] mp:w-[120px]  h-[52px]  flex flex-row item-center justify-center mx-auto py-3.5">
  ...
  <img src="/shoppingcart.svg" width="24px" height="24px"/>
        ...
        <div className="w-[160px] h-[20px] gap-[10px] flex flex-row item-center justify-center ml-8 mp:ml-2 2xl:ml-8 py-3.5">
            
          <div className="w-[134px] h-[12px] item-center justify-center mx-auto">
            <h2 className="font-mona-sans text-[14px] font-semibold leading-[19.2px] text-left">Hosting Overview</h2>  
          </div>
...
<img src="/arrow.svg" width="16px" height="20px"/>
      ...
      <div className="w-[216.41px] h-[26px] mt-8 md:mt-6 flex flex-row gap-1  " >
          ...
          <img src="/tick2.svg" alt="tick" width="11.41px" height="8.27px" className="opacity-100" />
          </div>
...
<h2 className="text-[14px] underline opacity-75 capitalize">30 day money back garantee</h2>
    ...
    <div className="w-full  2xl:w-[406px] h-[60px] 2xl:h-[473px] item-center justify-center sd:-mt-96 2xl:mt-0  sm:w-[350px] ">
