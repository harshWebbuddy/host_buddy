...
const IndependentHoverBoxesVertical = () => {
  return (
    <div className="flex flex-col pa:flex-row md:flex-row gap-8 items-center justify-center">
      <Box
...
const IndependentHoverBoxesStraight = () => {
  return (
    <div className="flex flex-col pa:flex-row md:flex-col gap-8">
      <Box
        imageSrc="/hirebox1.svg"
        title="Web Design"
        description="Laoreet scelerisque euismod egestas suspendisse."
...
const Pro = () => {
  ...
  return (
    <div className="mx-auto item-center justify-center w-full">
      <div className="bg-[#F9EFE4] w-full  md:w-[1219px] md:h-[1066px] rounded-3xl items-center justify-center mx-auto flex flex-col ">
        <div className="flex flex-col md:flex-row items-center justify-center mx-auto ">
        <div className="pt-20 md:pt-20 md:mr-28">
          <div className="flex flex-row w-[150px] md:w-[361px] h-[63px] gap-8 items-center justify-center ml-28 md:ml-2 ">
          ...
          <div className="flex flex-col gap-4 padding">
            ...
            <p className="md:w-[539px]">Lorem ipsum dolor sit amet consectetur. Ornare et amet lobortis ornare. Ullamcorper accumsan donec eu condimentum diam a augue arcu.</p>
          </div>
        </div>
        <motion.div className="md:w-[456px]  h-[511px] rounded-3xl flex flex-row md:p-10 " whileHover={{scale:1.11}}>
     <img src="/video.svg" className="w-[350px] md:w-[456px] h-[511px] md:ml-8  "/>
      </motion.div>
      </div>
      <div  className="flex flex-col md:flex-row gap-8 md:-mt-20 md:ml-8 mb-20 padding">
