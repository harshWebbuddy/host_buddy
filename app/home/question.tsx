  ...
  return (
    <div className="2xl:w-[1220px] md:h-[603.68px]  pa:w-full mx-auto margin  ">
      <div className="2xl:w-[779px] xl:ml-16 2xl:h-[63px] mt-20   mb-10 xl:mb-20 2xl:mb-20 ">
        ...
        <div className="w-[140px] xl:w-[200px] md:w-48 pa:w-36 h-1 bg-orange-500 md:mt-2 pa:-mt-2 -mt-4 ml-[190px] xl:ml-[600px] md:ml-[570px] pa:ml-[460px]  xl:-mt-6 2xl:ml-[570px] 2xl:mt-0 "></div>
      </div>
