  ...
  return (
    <div className="space-y-10 2xl:space-y-28 p-4 max-w-[1300px] mx-auto ">
      ...
      <div className="w-full 2xl:flex hidden justify-center">
        ...
        <div className="w-full space-y-6 2xl:space-y-10">
          ...
          <div className="w-full ">
            ...
            <div className="bg-white border-orange-500 border  w-44 2xl:w-60 p-4 rounded-2xl items-start flex flex-row justify-start">
      ...
      <div className="w-full space-y-6 2xl:space-y-10">
          ...
          <div className="bg-white border-orange-500 border w-52 2xl:w-72 p-4 rounded-2xl items-start flex flex-row justify-start">
      ...
      <div className="slide-reveal w-full flex flex-col xl:flex-row-reverse gap-x-32  2xl:space-y-0 space-y-16 items-center">
      <div className="w-full 2xl:flex hidden  justify-center">
          <div className="relative">
        ...
        <div className="w-full space-y-6 2xl:space-y-10">
         <div className="w-full ">
            <h2 className="text-[40px] 2xl:text-[52px]  leading-normal font-medium 2xl:font-bold">Affiliate Program Agreement</h2>
          </div>
          ...
          <div className="bg-white border-orange-500 border w-72  2xl:w-96 p-4 rounded-2xl items-start flex flex-row justify-start">
