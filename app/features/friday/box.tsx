    ...
    <div key={index} className="col-span-1 flex flex-col">
      <div className="flex-grow">
        <Image
          ...
          width={440}
          height={50}
          className="rounded-2xl relative z-[1] translate-y-16 w-full h-auto"
        />
      </div>
      <div className="group relative border bg-white hover:bg-[#FFF3EA] z-[2] px-4 md:px-8 lg:px-16 py-6 md:py-10 rounded-2xl space-y-5 flex flex-col h-full">
