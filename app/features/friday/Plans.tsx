    ...
    <div className="flex flex-col bl:flex-row w-full justify-center gap-4 items-center">
      ...
      <div className="relative top-0 bottom-0 group !z-[1] w-full p-4">
        ...
        <div className="w-full bg-white p-6 md:pl-16 md:pr-10 py-10 items-center justify-center rounded-2xl border group relative !z-[3] group-hover:shadow-2xl h-full">
          <div className="w-full space-y-4 items-start justify-start mx-auto">
            <span className="items-start featuresvg5 justify-start bg-orange-500 mx-auto w-auto">
              <Image src="/features/american.svg" width={200} height={200} alt="" />
            </span>
        ...
        <img src="/wordpress/rectbox.svg" alt="go" className="absolute bottom-0 left-0 !z-[2] opacity-0 group-hover:opacity-100" />
      </div>
    </div>
  </div>
</section>
