...
<path d="M0.898438 6.10781L3.09844 4.00781L7.99844 8.90781L12.8984 4.00781L15.0984 6.10781L7.99844 13.2078L0.898438 6.10781Z" fill="#BBBBBB"/>
          ...
          <div className="flex flex-col space-y-4 bl:flex-row justify-center items-center bl:justify-between mt-4">
          ...
          <label htmlFor="agreeTerms">I have read and agree to the terms and conditions <span className="ml-2 mr-2 leading-28 font-extrabold text-orange-500"> - HostBuddy</span></label>
            ...
            <div className="border-orange-500 border flex flex-row w-32 2xl:w-40 rounded-xl p-3 bg-orange-500 items-center justify-center cursor-pointer">
