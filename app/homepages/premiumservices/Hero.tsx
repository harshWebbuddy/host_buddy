...
const HeroHosting = () => {
  ...
  return (
    <section className="h-full min-h-[50vh] overflow-hidden relative bg-black flex items-center justify-center">
      ...
      <h1 className="font-mono-sans font-medium  text-[22px] xl:text-[51px] 2xl:text-[58px] leading-normal 2xl:leading-[84px] text-left 2xl:text-left ">IPTV Premium
      Services</h1>
            </div>
            ...
            <div className="2xl:h-[56px]  flex item-center justify-center bg-orange-500 rounded-xl py-4  px-6 2xl:px-12  gap-x-3">
              ...
              <h2 className="font-mona-sans text-[16px] 2xl:text-[18px] font-semibold leading-[21.6px] text-left">Subscribe Now</h2>
            </div>
            <div className="h-full  flex item-center justify-center  rounded-xl py-0 w-auto px-0  gap-x-3">
            <h2 className="font-mona-sans text-[14px] 2xl:text-[18px] font-semibold leading-[21.6px] text-left">Contact Us</h2>
