...
const Ratingpanel = () => {
  ...
  return (
    ...
    <div className="md:flex items-center justify-center pa:gap-x-2 2xl:gap-x-36 xl:gap-x-32 mt-16 mb-6 pa:ml-8 ">
      <div className="font-mona-sans font-semibold  2xl:w-[245px] text-center 2xl:p-0  p-4 md:text-left h-[63px] pa:-mt-32 2xl:-mt-2 mp:mb-8 xl:-mt-16">
        <h3 className="font-bold text-[23px]  leading-[63px] text-white ">Customer Happiness</h3>
      </div>
      <div className="flex flex-col md:flex-row pa:flex-row justify-between 2xl:mt-8  2xl:gap-x-4 xl:flex-nowrap pa:flex-wrap md:flex-nowrap 2xl:flex-nowrap">
