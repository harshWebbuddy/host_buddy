...
// export {default as panela} from './homegaming/panela.svg'
const Panel = () => {
  const images = [
  ...
  return (
    <div className="mp:mb-80 xl:mb-80 2xl:mb-80 gf:mb-60">
 ...
 <div  className="w-full bg-[#01131B] -mt-10 relative z-10">
   <section className="static w-full 2xl:w-[1920px] 2xl:h-[782px] flex flex-col 2xl:flex-row xl:h-[900px] mp:h-[1300px]   h-[1670px] pa:h-[1450px]  items-center justify-center mx-auto ">
      ...
      <div className="w-full 2xl:w-[1926px] mx-auto md:w-[699px] md:h-[608px] pa:mb-80 mp:mb-0 lg:mb-60 gf:mb-20">
...
<div className="group ">
  ...
  <p className="text-[16px] mp:ml-2 leading-[24px] font-mono-sans text-white opacity-70 2xl:w-[600px] mp:w-[350px] xl:w-full pa:w-[600px]  "> By trusting us with your business and projects needs, we promise a99.9% uptimeon any services we provide, outside of any standard. </p>
