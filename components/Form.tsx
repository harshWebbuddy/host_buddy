...
const ContactForm: React.FC = () => {
  ...
  <div className="flex flex-col md:flex-row gap-4 mt-4 items-center justify-center mx-auto">
    ...
    <div className="w-[350px] md:w-[600px] h-[53px] px-16 pt-17.61 pb-18.39 rounded-tl-10 relative">
  <select
    id="selectedDocument"
    name="selectedDocument"
    value={formData.selectedDocument}
    onChange={handleChange}
    className="border border-gray-300 rounded-md px-1 md:px-4 py-1 md:py-2 w-full text-left appearance-none"
    required
  >
  ...
  <div className="relative ml-48 flex items-center -top-7">
    <svg
