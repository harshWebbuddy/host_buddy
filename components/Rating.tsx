...
const Ratingpanel = () => {
  ...
  return (
    ...
    <div className="md:flex items-center justify-center pa:gap-x-2 md:gap-x-28  2xl:gap-x-20 mt-16 mb-6">
      ...
      <div className="flex flex-col md:flex-row pa:flex-row justify-between 2xl:mt-8 md:gap-2 2xl:gap-x-2 pa:flex-wrap md:flex-nowrap 2xl:flex-nowrap xl:flex-nowrap">
