  ...
  return (
    <header className={`absolute top-0 sp:w-full w-full px-4 py-4 z-[5] ${className}`}>
      <div className="w-full item-center justify-center mx-auto">
        <MobileSidebar onClose={() => setIsExpanded(false)} isOpen={isExpanded} navLinks={navLinks} />
        ...
        <nav className="w-full sm:w-full 2xl:w-[1230px] xl:w-[1230px] bl:w-full flex items-center 2xl:justify-center mx-auto justify-between">
          <div className="w-full">
            <div className="justify-center group">
              <span className="font-semibold text-[29.27px] text-white ">H</span>
              <span className="font-semibold text-[29.27px] text-orange-500 k">o</span>
              <span className="font-semibold text-white text-[29.27px] ">s</span>
              <span className="font-semibold text-[29.27px] text-white">t</span>
              <span className="font-semibold text-[29.27px] text-white ">Buddy</span>
            </div>
          </div>
