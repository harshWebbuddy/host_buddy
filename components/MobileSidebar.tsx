...
export default function MobileSidebar({ onClose, isOpen, navLinks }: Props) {
            ...
            <Link href={link.href} key={index}>
              <div
                ...
                className={`flex gap-[10px] items-center cursor-pointer ${
                  pathname === link.href &&
                  "text-transparent bg-gradient-to-r from-primary-purple to-primary-blue bg-clip-text font-semibold"
                }`}>
                <h1 className="whitespace-nowrap text-black">{link.label}</h1>
              </div>
            </Link>
          ))}
        </div>
