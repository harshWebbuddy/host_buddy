...
const FooterBox = () => {
  return (
    <div className='flex flex-col md:flex-row bg-orange-500 rounded-lg justify-between w-[300px] md:w-[1220px] h-[470px] md:h-[206.67px] p-5'>
      <div className='flex flex-col justify-between w-[230px] md:w-[453px] h-[132px] m-5 sm:m-10'>
      ...
      <div className='flex flex-col justify-between w-[230px] md:w-[546px] h-[170px] m-5 sm:m-10'>
        <div>
        ...
        <div className="flex justify-center h-[56px] md:w-[546px]">
          <div className="relative -mt-1 md:-mt-14 md:mr-10 ">
            ...
            />
            <button className="text-xs md:text-xl  absolute font-sans top-0.5 md:top-1 right-0.5 md:right-1 w-[120px] h-[51px] bg-gradient-to-b from-gray-800 to-gray-900 text-orange-500 rounded-xl flex justify-center items-center">
