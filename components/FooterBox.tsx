...
const FooterBox = () => {
  return (
    <div className='flex flex-col md:flex-row pa:flex-row bg-orange-500 rounded-lg justify-between w-[300px] 2xl:w-[1220px] 2xl:h-[206.67px] pa:w-[600px]  h-[470px] pa:h-[280px] md:h-[206.67px]  p-5'>
      ...
      <div className='flex flex-col justify-between w-[230px] 2xl:w-[546px] pa:w-[253px]  h-[170px] m-5 sm:m-10'>
        <div>
        ...
        <div className="flex justify-center h-[56px] md:w-[546px] ">
          <div className="relative -mt-1 md:-mt-14 md:mr-10  ">
            ...
            />
            <img src="/subscribe.svg" className='h-[51px] absolute inset-0 2xl:mt-0.5 2xl:m-4 2xl:ml-[359px]'/>
